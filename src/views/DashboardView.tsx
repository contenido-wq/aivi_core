          ...
          isShortScreen ? (
            ...
            <div style={{ flex: 1, overflow: "auto", WebkitOverflowScrolling: "touch", display: "flex", flexDirection: "column" }}>
              ...
              <div style={{
                ...
                <DelayedPanel users={delayedUsers} cancelledUsers={cancelledUsers} cancelledByDay={cancelledByDay} />
            ...
            {isTablet ? (
              <div style={{ padding: `10px ${px}px 0`, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  <DelayedPanel users={delayedUsers} cancelledUsers={cancelledUsers} cancelledByDay={cancelledByDay} mobile />
